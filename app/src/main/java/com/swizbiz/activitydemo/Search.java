...
public class Search extends Activity {
    ...
    private TextView searchLastNameTextView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        searchNameTextView = findViewById(R.id.text_view_search_name);
        searchLastNameTextView = findViewById(R.id.text_view_search_last_name);

        if (savedInstanceState == null) {
            testModel = new TestModel();
            DataGenerator.fillTestModel(testModel);
            searchNameTextView.setText(testModel.getName());
            searchLastNameTextView.setText(testModel.getLastName());
        }
    }
